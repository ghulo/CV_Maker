...
$header_subtitle = "Krijo Llogari të Re";
...
<head>
  ...
  <title>Regjistrohu - CV Maker</title>
...
<body>
  ...
  <main class="main">
    <div class="signup-form-container login-form-container page-container animate-in">
      <h2 class="reveal-on-scroll">Regjistrohu në CV Maker</h2>
      <p class="form-intro-text reveal-on-scroll" data-reveal-delay="100">Krijo llogarinë tënde falas për të filluar ndërtimin e CV-së tënde profesionale menjëherë.</p>

      <div id="signup-message-area" class="message-area"></div> <form class="signup-form" method="POST" action="process_signup.php"> <div class="form-group reveal-on-scroll" data-reveal-delay="150">
          <label for="email">Email</label>
          <div class="input-icon-wrapper">
            <i class="fas fa-envelope input-icon"></i>
            <input type="email" name="email" id="email" required placeholder="psh. emri@shembull.com">
          </div>
        </div>
        <div class="form-group reveal-on-scroll" data-reveal-delay="200">
          ...
          <div class="input-icon-wrapper">
            ...
            <input type="password" name="password" id="password" required minlength="6" placeholder="Minimumi 6 karaktere">
          </div>
        </div>
        <div class="form-group reveal-on-scroll" data-reveal-delay="250">
          ...
          <div class="input-icon-wrapper">
            ...
            <input type="password" name="confirm_password" id="confirm_password" required minlength="6" placeholder="Përsërit fjalëkalimin">
          </div>
        </div>
        <button type="submit" class="btn-primary-form btn btn-primary reveal-on-scroll" data-reveal-delay="300">Regjistrohu <i class="fas fa-user-plus icon-right"></i></button>
      </form>
      <p class="form-alternate-action reveal-on-scroll" data-reveal-delay="350">Keni llogari? <a href="login.php">Kyçu këtu</a></p>
    </div>
  </main>
