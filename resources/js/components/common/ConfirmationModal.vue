  ...
  <div v-show="isVisible" :class="['modal-overlay', { 'is-visible': isVisible }]">
    <div class="modal-content">
      ...
      <div class="modal-actions">
        ...
        <button @click="confirm" :class="['btn', confirmButtonClass]">{{ confirmButtonText }}</button>
      </div>
    </div>
  </div>
</template>
...
.modal-content {
  ...
  transform: translateY(-20px) !important; /* Force initial position */
  transition: all 0.3s ease-out !important;
  opacity: 1 !important; /* Force content visible */
}
.modal-overlay.is-visible .modal-content {
    transform: translateY(0px) !important; /* Force final position */
}
...
body.dark-theme .modal-title { color: var(--dark-neutral-text); }
...
body.dark-theme .modal-message { color: var(--dark-muted-text); }
