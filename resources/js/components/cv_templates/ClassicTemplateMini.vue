<template>
  <div
    class="classic-mini-cv-content p-4 text-neutral-text dark:text-dark-neutral-text border border-neutral-border dark:border-dark-neutral-border rounded-lg scale-75 origin-top-left overflow-hidden h-64 w-full relative"
  >
    <!-- Scaled down classic template layout -->
    <div class="relative h-full">
      <header
        class="text-center mb-4 pb-2 border-b border-divider-color dark:border-dark-divider-color"
      >
        <h3 class="text-lg font-bold text-neutral-text dark:text-dark-neutral-text">
...
<style scoped>
  .classic-mini-cv-content {
    /* Adjust dimensions and scaling as needed */
    transform-origin: top left;
    /* Hide scrollbars but allow content to exist for scaling */
    overflow: hidden;
  }
  .line-clamp-3 {
    display: -webkit-box;
