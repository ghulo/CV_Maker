<template>
  <div class="creative-mini-cv-content p-4 text-neutral-text dark:text-dark-neutral-text border border-neutral-border dark:border-dark-neutral-border rounded-lg scale-75 origin-top-left overflow-hidden h-64 w-full relative">
    ...
    <div class="relative h-full">
      ...
      <header class="text-center mt-4 mb-3 pb-2 border-b border-gray-200 dark:border-gray-700">
        <h3 class="text-lg font-bold text-gray-900 dark:text-white">{{ cv.personal_details.full_name || 'Emri Mbiemri' }}</h3>
        <p class="text-xs text-primary-600 dark:text-primary-400 font-semibold">{{ cv.summary || 'Pozicioni' }}</p>
      </header>
      ...
      <main class="grid grid-cols-3 gap-2">
        ...
        <div class="col-span-1 pr-1">
          <section class="mb-2">
            <h4 class="text-sm font-semibold text-neutral-text dark:text-dark-neutral-text border-b border-primary dark:border-primary-400 pb-0.5 mb-1">Aftësitë</h4>
        ...
        <div class="col-span-2 pl-1">
          <section class="mb-2">
            <h4 class="text-sm font-semibold text-neutral-text dark:text-dark-neutral-text border-b border-primary dark:border-primary-400 pb-0.5 mb-1">Përvoja</h4>
          ...
          <section>
            <h4 class="text-sm font-semibold text-neutral-text dark:text-dark-neutral-text border-b border-primary dark:border-primary-400 pb-0.5 mb-1">Edukimi</h4>
